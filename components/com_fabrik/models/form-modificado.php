...
class FabrikFEModelForm extends FabModelForm
{
	...
	public function getFormCss()
	{
		...
		if ($tmpl != '')
		{
			...
			if (!FabrikHelperHTML::stylesheet($tmplPath))
			{
				$ok = FabrikHelperHTML::stylesheet('components/com_fabrik/views/' . $view . '/' . $jTmplFolder . '/' . $tmpl . '/template_css.php' . $qs);
			}
			...
			if (!FabrikHelperHTML::stylesheet('templates/' . $app->getTemplate() . '/html/com_fabrik/' . $view . '/' . $tmpl . '/custom.css' . $qs))
			{
				FabrikHelperHTML::stylesheet('components/com_fabrik/views/' . $view . '/' . $jTmplFolder . '/' . $tmpl . '/custom.css' . $qs);
			}

			$path = 'templates/' . $app->getTemplate() . '/html/com_fabrik/' . $view . '/' . $tmpl . '/custom_css.php' . $qs;

			
			if (!FabrikHelperHTML::stylesheet($path))
			{
			
				FabrikHelperHTML::stylesheet('components/com_fabrik/views/' . $view . '/' . $jTmplFolder . '/' . $tmpl . '/custom_css.php' . $qs);
			}
		}
