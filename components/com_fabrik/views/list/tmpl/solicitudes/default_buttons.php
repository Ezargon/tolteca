...
if(strpos($url,"mis-solicitudes"))
{ // ES UN ESTUDIANTE, NO SE MUESTRA HISTORICO
	$historico = false;
}
else
{	
	if(strpos($url,"historico"))
	{//SE ENCUENTRA EN EL HISTÓRICO
		if(strpos($url,"historico-sa"))
		{//es administrador
			$enlace .= "solicitudes";
		}
		else 
		{//es coordinador
			$enlace .= "solicitudes-recibidas";
		}
		$texto .="Salir del hist&oacute;rico";
	}
	else
	{//SE ENCUENTRA EN EL LISTADO PRINCIPAL
		if(strpos($url,"solicitudes-recibidas"))
		{//es coordinador
			$enlace .= "solicitudes-recibidas/historico-sc";
		}
		else
		{//es administrador
			$enlace .= "solicitudes/historico-sa";
		}
		$texto .="Ir al hist&oacute;rico";
	}
}	
