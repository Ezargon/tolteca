...
class FabrikViewFormBase extends JViewLegacy
{
	...
	protected function _loadTmplBottom(&$form)
	{
		...
		if ($this->isMultiPage)
		{
			$form->prevButton = '<button type="button" class="btn fabrikPagePrevious button" name="fabrikPagePrevious" onClick="javascript:detectar(-1);"><i class="icon-previous"></i>&nbsp;'
				. JText::_('COM_FABRIK_PREV') . '</button>';
			$form->nextButton = '<button type="button" class="btn fabrikPageNext button" name="fabrikPageNext" onClick="javascript:detectar(1);">'
